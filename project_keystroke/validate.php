...
<head>
  ...
  <link rel="stylesheet" href="../content/css/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="../content/css/metro-bootstrap.css">
    <link rel="stylesheet" href="../content/docs/font-awesome.css">
  <!-- Google Fonts-------------------------------------------------------------- -->
  ...
  <!-- --------------------------------------------------------------Google Fonts -->
    ...
    <!-- -------------------------------------------------------------- -->
    <!-- -------------------------------------------------------------- -->
  <link rel="stylesheet" href="../content/keyboardapp/main.css"> 
</head>
<body>
...
<body>
 <div class="container">
  <div class="row">
            ...
            <span class="help-block">Type password without special keys and press Enter for Authentication.Refresh in case of Backspace</span>
            </form> 
  </div>
  <div class="row">
...
var safecount=0;var threshold=.30;
...
function justcheck()
{
  $.get("getmono.php",{username:'<?php echo $user; ?>'},function(data){prevmono=data;}).done(function(data){jsonrevmono=JSON.parse(prevmono);$.get("getpp.php",{username:'<?php echo $user; ?>'},function(data){prevpp=data;}).done(function(data){ jsonrevpp=JSON.parse(prevpp);$.get("getpr.php",{username:'<?php echo $user; ?>'},function(data){prevpr=data;}).done(function(data){ jsonrevpr=JSON.parse(prevpr);$.get("getrr.php",{username:'<?php echo $user; ?>'},function(data){prevrr=data;}).done(function(data){ jsonrevrr=JSON.parse(prevrr);
      ...
      var ad=rvalueifsheety(rr,jsonrevrr);
        var average=0.683*ad+0.417*res;        
      document.getElementById("display").innerHTML="   res="+res+"  ad="+ad+"   average="+average;
   if(average<threshold)
  {
   document.getElementById("display").innerHTML+="    WELCOME <?php echo $user; ?>";
  }
  else
  {
...
<script type="text/javascript" src="../content/docs/bootstrap-tooltip.js"></script>

<script type="text/javascript" src="../content/docs/bootstrap-alert.js"></script>
<script type="text/javascript" src="../content/docs/bootstrap-button.js"></script>
<script type="text/javascript" src="../content/docs/bootstrap-carousel.js"></script>
<script type="text/javascript" src="../content/docs/bootstrap-collapse.js"></script>
<script type="text/javascript" src="../content/docs/bootstrap-dropdown.js"></script>
<script type="text/javascript" src="../content/docs/bootstrap-modal.js"></script>
<script type="text/javascript" src="../content/docs/bootstrap-popover.js"></script>
<script type="text/javascript" src="../content/docs/bootstrap-scrollspy.js"></script>
<script type="text/javascript" src="../content/docs/bootstrap-tab.js"></script>
<script type="text/javascript" src="../content/docs/bootstrap-transition.js"></script>
<script type="text/javascript" src="../content/docs/bootstrap-typeahead.js"></script>
<script type="text/javascript" src="../content/docs/jquery.validate.js"></script>
<script type="text/javascript" src="../content/docs/jquery.validate.unobtrusive.js"></script>
<script type="text/javascript" src="../content/docs/jquery.unobtrusive-ajax.js"></script>
<script type="text/javascript" src="../content/docs/metro-bootstrap/metro-docs.js"></script>
<script type="text/javascript"> 
